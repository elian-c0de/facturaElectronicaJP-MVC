...
class clientesDataTableController
{
    ...
    public function data()
    {
        ...
        if (!empty($_POST)) {
            ...
            $url = "ecmp_cliente?select=*" . "&linkTo=fec_actualiza&filterTo=cod_empresa&inTo=".$_GET["code"];
            $method = "GET";
            $fields = array();
            ...
            if (!empty($_POST['search']['value'])) {
                ...
                if (preg_match('/^[0-9A-Za-zñÑáéíóú ]{1,}$/', $_POST['search']['value'])) {
                    ...
                    $linkTo = ["num_id", "nom_apellido_rsocial", "nom_persona_nombre", "txt_direccion","num_telefono","txt_email","cod_precio"];
                ...
                $url = "ecmp_cliente?select=*"."&linkTo=fec_actualiza&startAt=".$start."&endAt=".$length."&orderAt=cod_empresa&filterTo=cod_empresa&inTo=".$_GET["code"];
                $data = CurlController::request($url, $method, $fields)->result;
