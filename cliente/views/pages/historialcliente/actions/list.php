                    ...
                    <div class="mx-auto" style="padding: 20px;">
                                <form id="user-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" class="form-control mb-3" id="cliente" placeholder="Codigo" required>
                                        </div>
                                        <div class="col-md-8">
                                            <p>Nombre</p>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <input type="date" class="form-control mb-3" id="desde" required>
                                        </div>
                                        <div class="col-md-1">
                                            <p>Hasta:</p>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="date" class="form-control mb-3" id="ahora" required>
                                        </div>
                                    </div>
