...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">
      <a class="btn bg-blue btn-small" href="facturacion/create"><i class="bi bi-file-earmark-plus-fill"></i></a>
  ...
  <!-- /.card-header -->
  <div class="card-body">
    <table id="facturaciontable" class="table table-bordered table-striped">
      <thead>
        <tr>
            <th>Código</th>
            <th>Descripcion</th>
...
<script src="views/assets/custom/datatable/facturacion.js"></script>