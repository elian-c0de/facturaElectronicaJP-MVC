      ...
      <div class="card-header">
        ...
        <div class="col-md-8 offset-md-2">
          ...
          <div class="form-group mt-2">
            <label>Código: </label>
            <input type="text" name="cod_usuario" id="cod_usuario" class="form-control" onchange="validateRepeat(event,'nom_usuario','gen_usuario','cod_usuario', <?php echo $_SESSION['admin']->cod_empresa ?>)" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ0-9]{1,20}" required>
          ...
          <div class="form-group mt-2">
            <label>Nombre:</label>
            <input type="text" name="nom_usuario" id="nom_usuario" class="form-control" onchange="validateRepeat(event,'nom_usuario','gen_usuario','nom_usuario', <?php echo $_SESSION['admin']->cod_empresa ?>)" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ0-9 ]{1,50}" required>
            <div class="valid-feedback">Válido</div>
            <div class="invalid-feedback"> Por Favor, rellene este campo</div>
          </div>
          ...
          <div class="form-group mt-2">
            ...
            <div class="input-group">
              <input type="password" name="cod_passwd" id="cod_passwd" class="form-control" onchange="validateRepeat(event,'cod_passwd','gen_usuario','cod_passwd', <?php echo $_SESSION['admin']->cod_empresa ?>)" pattern="[-//0-9A-Za-zñÑáéíóúÁÉÍÓÚ]{8,20}$" placeholder="Contraseña como minimos 8 Dígitos" required>
              <div class="valid-feedback">Válido</div>
              <div class="invalid-feedback"> Por Favor, rellene este campo</div>
