      ...
      <a class="btn bg-green btn-small" href=""><i class="bi bi-filetype-xml"></i></a>
        ...
        <div class="card-title">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="md-auto" style="padding: 20px;">
                                <form id="user-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control mb-3" id="documento"  name="documento" placeholder="" required>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                                            <p>Establecimiento:</p>
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" class="form-control mb-3" id="esta" placeholder="" required>
                                        </div>
                                        <br></br>
                                        <div class="col-md-1">
                                            <p>Desde:</p>
                                        ...
                                        <div class="col-md-2">
                                            <input type="date" class="form-control mb-3" id="desde" placeholder="" required>
                                        </div>
                                        <div class="col-md-1">
                                            <p>Hasta:</p>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="date" class="form-control mb-3" id="hasta" placeholder="" required>
                                        </div>
                                    </div>
