...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">
      <a class="btn bg-blue btn-small" href="gastosCompras/create"><i class="bi bi-file-earmark-plus-fill"></i></a>
  ...
  <!-- /.card-header -->
  <div class="card-body">
    <table id="gastosComprastable" class="table table-bordered table-striped">
      <thead>
        <tr>
...
<script src="views/assets/custom/datatable/gastosCompras.js"></script>