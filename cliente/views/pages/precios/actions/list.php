                    ...
                    <div class="mx-auto" style="padding: 20px;">
                                <form id="user-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" class="form-control mb-3" id="articulo" placeholder="Articulo" required>
                                        </div>
                                        <div class="col-md-5">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control mb-3" id="establecimiento" placeholder="" required>
                                        </div>
                                        <div class="col-md-2">
                                            <p>Precio:</p>
                                        </div>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control mb-3" id="precio" placeholder="" required>
                                        </div>
                                    </div>
