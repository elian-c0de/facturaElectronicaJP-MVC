...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">
      <a class="btn bg-blue btn-small" href="movimientoCaja/create"><i class="bi bi-file-earmark-plus-fill"></i></a>
      <a class="btn bg-blue btn-small" href="movimientoCaja/createCierreCaja"><i class="bi bi-box-seam-fill"></i> Cierre de Caja</a>
  ...
  <!-- /.card-header -->
  <div class="card-body">
    <table id="movimientoCajatable" class="table table-bordered table-striped">
      <thead>
        <tr>
            <th>Codigo Caja</th>
...
<script src="views/assets/custom/datatable/movimientoCaja.js"></script>