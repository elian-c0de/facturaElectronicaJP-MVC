...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
      <h1><i class="fa-solid fa-money-check-dollar mr-1"></i>Formas de Pago</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-left">
          ...
          if (isset($routesArray1[4])) {
            if($routesArray1[4] == "create" || $routesArray1[4] == "edit"){
              echo '<li class="breadcrumb-item"><a href="formadepago">Formadepago</a></li>';
              echo '<li class="breadcrumb-item active">'.$routesArray1[4].'</li>';
            }
          }else{
            echo '<li class="breadcrumb-item active">Formadepago</li>';
          }
      ?>
        </ol>
      </div>
